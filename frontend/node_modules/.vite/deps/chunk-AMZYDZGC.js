...
function increment_pending() {
  ...
  var boundary = effect2.b;
  var batch = (
    /** @type {Batch} */
    current_batch
  );
  var blocking = !!(boundary == null ? void 0 : boundary.is_rendered());
  boundary == null ? void 0 : boundary.update_pending_count(1, batch);
...
traverse_fn = function(root, effects, render_effects) {
  ...
  while (effect2 !== null) {
    ...
    var skip = is_skippable_branch || (flags & INERT) !== 0 || __privateGet(this, _skipped_branches).has(effect2);
  ...
  const mark = (value) => {
    ...
    for (const reaction of reactions) {
      ...
      if ((flags & DERIVED) !== 0) {
        ...
        if (flags & (ASYNC | BLOCK_EFFECT) && !this.async_deriveds.has(effect2)) {
...
function managed(fn, flags = 0) {
  var effect2 = create_effect(MANAGED_EFFECT | flags, fn);
  if (true_default) {
    effect2.dev_stack = dev_stack;
  }
  return effect2;
...
//# sourceMappingURL=chunk-AMZYDZGC.js.map
